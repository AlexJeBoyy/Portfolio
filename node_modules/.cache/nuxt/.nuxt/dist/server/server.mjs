import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, h, resolveComponent, computed, unref, mergeProps, withCtx, createTextVNode, toDisplayString, useSSRContext, provide, ref, Suspense, Fragment, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "C:/SD/Portfolio/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/SD/Portfolio/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/SD/Portfolio/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "C:/SD/Portfolio/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { defu } from "C:/SD/Portfolio/node_modules/defu/dist/defu.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash } from "C:/SD/Portfolio/node_modules/ufo/dist/index.mjs";
...
import { useHead as useHead$1, headSymbol } from "C:/SD/Portfolio/node_modules/@unhead/vue/dist/index.mjs";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    name: "projects-slug",
    path: "/projects/:slug()",
    component: () => import("./_nuxt/_slug_-B4x9vNiQ.js")
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/index-8GMOVe6_.js")
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import("./_nuxt/index-Chm7kEI8.js")
  },
  {
    name: "skills",
    path: "/skills",
    component: () => import("./_nuxt/index-Cc5WrshK.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BzoCoxui.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BfNc_JYv.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BOhQQH7V.js"));
